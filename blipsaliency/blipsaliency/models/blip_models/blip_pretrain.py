...
from blipsaliency.models.base_model import MomentumDistilationMixin, SharedQueueMixin
from blipsaliency.models.blip_models import tie_encoder_decoder_weights
from blipsaliency.models.blip_models.blip import BlipBase
from blipsaliency.models.blip_models.blip_outputs import (
    BlipOutput,
    BlipSimilarity,
    BlipIntermediateOutput,
)
from blipsaliency.models.med import XBertEncoder, XBertLMHeadDecoder
from blipsaliency.models.vit import VisionTransformerEncoder
...
class BlipPretrain(BlipBase, SharedQueueMixin, MomentumDistilationMixin):
    ...
    def forward(self, samples):
        ...
        Examples:
            >>> import torch
            >>> from blipsaliency.models import load_model
