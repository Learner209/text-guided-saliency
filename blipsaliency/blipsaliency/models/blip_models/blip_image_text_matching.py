...
from blipsaliency.models.med import XBertEncoder
...
def compute_gradcam(model: BlipITM, visual_input, text_input, tokenized_text, block_num: int = 6):
    ...
    with torch.no_grad():
        ...
        for ind in range(visual_input.size(0)):
            ...
            # print(f"token_length: {token_length_}")
