...
from blipsaliency.models.base_model import BaseModel
...
def load_model(name, model_type, is_eval=False, device="cpu", checkpoint=None):
    ...
    >>> from blipsaliency.models import model_zoo
    >>> print(model_zoo)
...
def load_preprocess(config):
    ...
    logger.info("Visual pretrained model: {} | Text pretrained model: {}".format(vis_proc_cfg, txt_proc_cfg))
...
def load_model_and_preprocess(name, model_type, is_eval=False, device="cpu"):
    ...
    if cfg is not None:
        ...
        logger.info("Loading the preprocessors from the default config file...")
